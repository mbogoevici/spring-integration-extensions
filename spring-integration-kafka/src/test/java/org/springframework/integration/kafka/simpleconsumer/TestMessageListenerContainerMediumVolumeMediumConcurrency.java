 ...
 */
public class TestMessageListenerContainerMediumVolumeMediumConcurrency extends AbstractMessageListenerContainerTest {
	...
	public void testMessageListenerContainer() throws Exception {
		runMessageListenerTest(100, 5, PARTITION_COUNT, 10000);
	}
