 ...
 */
public class TestMessageListenerContainerHighVolumeHighConcurrency extends AbstractMessageListenerContainerTest {
	...
	public void testMessageListenerContainer() throws Exception {
		runMessageListenerTest(100, 20, PARTITION_COUNT, 100000);
	}
