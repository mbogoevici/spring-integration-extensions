 ...
 */
public class TestMessageListenerContainerMediumVolumeLowConcurrency extends AbstractMessageListenerContainerTest {
	...
	public void testMediumVolumeLowConcurrency() throws Exception {
		runMessageListenerTest(100, 2, PARTITION_COUNT, 10000);
	}
